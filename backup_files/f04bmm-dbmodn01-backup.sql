...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `email` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
...
CREATE TABLE `user_email` (
  `muser` varchar(30) DEFAULT NULL,
  `muser_email_add` varchar(120) DEFAULT NULL,
  UNIQUE KEY `constr_muser` (`muser`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ENCRYPTION='Y';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping events for database 'email'
--

--
-- Dumping routines for database 'email'
--
/*!50003 DROP PROCEDURE IF EXISTS `listexpired` */;
...
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `listexpired`()
begin
SELECT
  user,
  host,
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `monitor` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */;
...
CREATE TABLE `backup_log` (
  ...
  `event_handle` char(8) DEFAULT NULL,
  `open_date` varchar(30) DEFAULT NULL,
  `close_date` varchar(30) DEFAULT NULL,
  `db_size` bigint(20) DEFAULT NULL,
  `run_message` varchar(80) DEFAULT NULL,
  `timestamp1` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ENCRYPTION='Y';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `checkdb_log`
--

DROP TABLE IF EXISTS `checkdb_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `checkdb_log` (
  `server_name` varchar(50) DEFAULT NULL,
  `database_name` varchar(50) DEFAULT NULL,
  `start_time` varchar(30) DEFAULT NULL,
  `end_time` varchar(30) DEFAULT NULL,
  `warning` tinyint(4) DEFAULT NULL,
...
--
-- Table structure for table `logscan_log`
--

DROP TABLE IF EXISTS `logscan_log`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `logscan_log` (
  `server_name` varchar(50) DEFAULT NULL,
  `timestamp1` datetime DEFAULT NULL,
  `linecount` int(11) DEFAULT NULL,
...
--
-- Temporary table structure for view `passwords_expiry`
--

DROP TABLE IF EXISTS `passwords_expiry`;
/*!50001 DROP VIEW IF EXISTS `passwords_expiry`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE VIEW `passwords_expiry` AS SELECT 
 1 AS `NAME`,
 1 AS `host`,
 1 AS `Status`,
 1 AS `ServerExpirationInterval`,
 1 AS `DaysTillExpiration`,
 1 AS `EXPIRED_DATE`*/;
...
CREATE TABLE `user_account_history` (
  ...
  PRIMARY KEY (`id`),
  KEY `host` (`host`,`user`,`created_date`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 ENCRYPTION='Y';
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Final view structure for view `passwords_expiry`
--
...
/*!50013 DEFINER=`root`@`arlu5` SQL SECURITY DEFINER */
/*!50001 VIEW `passwords_expiry` AS select `uah`.`user` AS `NAME`,`uah`.`host` AS `host`,'UNLOCKED' AS `Status`,'90' AS `ServerExpirationInterval`,(to_days((`uah`.`created_date` + interval 90 day)) - to_days(now())) AS `DaysTillExpiration`,(`uah`.`created_date` + interval 90 day) AS `EXPIRED_DATE` from `user_account_history` `uah` where ((`uah`.`created_date` = (select max(`uah2`.`created_date`) from `user_account_history` `uah2` where ((`uah`.`user` = `uah2`.`user`) and (`uah`.`host` = `uah2`.`host`)))) and (`uah`.`created_date` < (now() - interval 69 day))) */;
...
-- Dump completed on 2020-05-13 15:45:34
